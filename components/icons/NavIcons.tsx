...
export const CalendarIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 15.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
  </svg>
);
...
export const SettingsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="m11.106 12.453 2.03 4.832c.083.197.31.307.53.233l1.758-1.035a.6.6 0 0 1 .623.233l2.898 4.852c.374.63.186 1.413-.444 1.787a1.125 1.125 0 0 1-1.226.111l-4.852-2.898a1.125 1.125 0 0 1-.623-1.022v-5.59c0-.401.196-.774.522-1.022l4.852-2.898c.63-.374 1.413-.186 1.787.444l2.898 4.852a.6.6 0 0 1-.233.623l-1.758 1.035c-.22.13-.447.02-.53-.233l-2.03-4.832c-.083-.197-.31-.307-.53-.233l-1.758 1.035a.6.6 0 0 1-.623.233Z" />
  </svg>
);
